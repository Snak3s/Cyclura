...
<head>
	...
	<script>
		function post()
		{
			...
			xmlhttp.open("POST","/trypost.php",true);
			xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
			xmlhttp.send("title="+encodeURIComponent(document.getElementById("title").value)+"&text="+encodeURIComponent(document.getElementById("editor").innerText));
...
<body style="margin: 0px;">
	<div class="page">
		...
		<div class="content">
			...
			<div class="text">
				标题：<input class="input" type="input" id="title"/>
				<pre id="editor" class="input input-min" contenteditable="true"></pre>
